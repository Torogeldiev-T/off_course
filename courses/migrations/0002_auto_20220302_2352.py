...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='module',
            name='type',
            field=models.CharField(choices=[('Assignment', 'Assignment'), ('Test', 'Test'), ('Quiz', 'Quiz')], default='Topic', max_length=12),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(limit_choices_to={'model__in': ('text', 'video', 'image', 'file', 'quiz', 'assignment')}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
